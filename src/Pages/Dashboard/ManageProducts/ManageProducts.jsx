...
const ManageProducts = () => {
    ...
    const { name, category, price, stock, description, brand, _id } = useLoaderData()
    ...
    const handleDeleteProduct = async (id) => {
        Swal.fire({
            ...
            .then(res => {
                if (res.isConfirmed) {
                    axiosSecure.delete(`/components/${id}`)
                        .then(result => {
                ...
                <form className='bgmx-4 px-6' onSubmit={handleSubmit(handleUpdateProduct)}>
                    ...
                    <div className="flex gap-6">
                        ...
                        <div className="form-control w-full my-6">
                            ...
                            <select defaultValue={brand} {...register('brand', { required: true })}
                                className="select select-bordered w-full">
